...
```
Now we have captured a lot more of the defaults. Of the total defaults, our model was correct 24% of the time. Additionally, 40% of the defaults it predicted were in fact defaults.